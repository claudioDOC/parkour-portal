<script lang="ts">
	...
	let { name, class: className = 'h-5 w-5 shrink-0' }: { name: Name; class?: string } = $props();
	const stroke = 'currentColor';
</script>

<!-- Heroicons-style 24 outline, stroke 1.75 -->
{#if name === 'home'}
...
{:else if name === 'user'}
	<svg xmlns="http://www.w3.org/2000/svg" class={className} fill="none" viewBox="0 0 24 24" stroke-width="1.75" stroke={stroke}>
